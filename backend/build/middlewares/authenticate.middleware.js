...
const isAuthenticated = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const userToken = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split("Bearer ")[1];
        if (!userToken)
        ...
        try {
            ...
            const userAuth = yield user_dependencies_1.default.services.findById(userId);
            if (!userAuth.enabled)
                throw new exceptions_1.UnauthorizedException();
            req.user = userAuth;
        }
