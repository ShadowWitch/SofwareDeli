...
class AuthServices {
    ...
    signIn(credentials) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isValidPassword = yield this.bcrypt.compareAsync(credentials.password, user.password);
            ...
            dependecies_1.emailSender.sendEmail(user.email, "Alerta de inicio de sesión", `Se ha iniciado sesión en su cuenta`, `
				...
				<a href="${env_1.env.CLIENT_PUBLIC_URL}/auth/recover">Recuperar cuenta</a>
    ...
    changePassword(id, oldPassword, newPassword) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isPasswordValid = yield this.bcrypt.compareAsync(oldPassword, userFound.password);
            if (!isPasswordValid) {
                throw new exceptions_1.HttpException(401, "Invalid credentials");
            }
    ...
    forgotPassword(email) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            dependecies_1.emailSender.sendEmail(userFound.email, "Recuperar cuenta", `Se ha solicitado un cambio de contraseña para su cuenta. Si no ha sido usted, ignore este mensaje. Si ha sido usted, haga click en el siguiente enlace: ${process.env.CLIENT_PUBLIC_URL}/reset-password/${userFound.id}`, `
				...
				<a href="${env_1.env.CLIENT_PUBLIC_URL}/auth/reset-password?token=${resetPasswordToken}">Cambiar contraseña</a>
    ...
    resetPassword(id, newPassword) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield dependecies_1.emailSender.sendEmail(userUpdated.email, "Cambio de contraseña", `Se ha cambiado la contraseña de su cuenta`, `
				<h1>Cambio de contraseña</h1>
