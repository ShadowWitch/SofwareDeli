...
const user_dependencies_1 = __importDefault(require("../../user/infrastructure/user-dependencies"));
...
const authServices = new auth_services_1.AuthServices(user_dependencies_1.default.services);
