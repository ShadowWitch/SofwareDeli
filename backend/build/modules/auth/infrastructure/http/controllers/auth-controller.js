...
class AuthController {
    ...
    signIn(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const userSigned = yield this.authService.signIn(userCredentials);
                const httpResponse = {
    ...
    signOut(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const userSignedOut = yield this.authService.signOut(userLogged);
                const httpResponse = {
                    data: userSignedOut,
    ...
    desactivateAccount(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.user;
                const userDesativated = yield this.authService.desactivateAccount(id);
                const httpResponse = {
    ...
    changePassword(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const userChangedPassword = yield this.authService.changePassword(id, oldPassword, password);
                const httpResponse = {
    ...
    resetPassword(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const userResetedPassword = yield this.authService.resetPassword(id, new_password);
                const httpResponse = {
