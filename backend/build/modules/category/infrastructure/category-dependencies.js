...
const categoryRepository = new prisma_category_repository_1.PrismaCategoryRepository(prisma_1.prisma);
const categoryServices = new category_services_1.CategoryServices(categoryRepository);
const categoryController = new category_controller_1.CategoryController(categoryServices);
