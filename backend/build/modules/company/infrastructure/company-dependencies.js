...
const companyRepository = new prisma_company_repository_1.PrismaCompanyRepository(prisma_1.prisma);
const companyServices = new company_services_1.CompanyServices(companyRepository);
const companyController = new company_controller_1.CompanyController(companyServices);
