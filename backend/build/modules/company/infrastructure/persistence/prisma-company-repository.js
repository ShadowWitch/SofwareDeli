...
class PrismaCompanyRepository {
    ...
    findMany(options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const items = yield this.prisma.company.findMany({
    ...
    findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const item = yield this.prisma.company.findUnique({
                where: { id },
            });
            return item;
        });
    ...
    findByName(name) {
        return __awaiter(this, void 0, void 0, function* () {
            const item = yield this.prisma.company.findFirst({
                where: { name },
            });
            return item;
        });
    ...
    createOne(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const item = yield this.prisma.company.create({
                data,
            });
            return item;
        });
    ...
    createMany(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const itemsCreated = (yield this.prisma.company.createMany({
                data,
                skipDuplicates: true,
            }));
            return itemsCreated;
    ...
    updateById(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const item = yield this.prisma.company.update({
                where: { id },
                data,
            });
            return item;
    ...
    updateMany(ids, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const itemsUpdated = (yield this.prisma.company.updateMany({
                where: {
                    id: {
                        in: ids,
                    },
    ...
    deleteById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const item = yield this.prisma.company.delete({
                where: { id },
            });
            return item;
        });
