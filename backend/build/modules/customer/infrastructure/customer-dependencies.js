...
const customerRepository = new prisma_customer_repository_1.PrismaCustomerRepository(prisma_1.prisma);
const customerServices = new customer_services_1.CustomerServices(customerRepository);
const customerController = new customer_controller_1.CustomerController(customerServices);
