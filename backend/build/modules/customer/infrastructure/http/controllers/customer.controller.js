...
class CustomerController {
    ...
    createOne(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const customerCreated = yield this.customerService.createOne(customerData);
                const httpResponse = {
    ...
    updateOneById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const customerData = req.body;
            try {
                const customerUpdated = yield this.customerService.updateById(id, customerData);
                const httpResponse = {
    ...
    deleteOneById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            try {
                const customerDeleted = yield this.customerService.deleteById(id);
                const httpResponse = {
