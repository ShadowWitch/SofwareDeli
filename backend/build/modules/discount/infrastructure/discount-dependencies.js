...
const discountRepository = new prisma_discount_repository_1.PrismaDiscountRepository(prisma_1.prisma);
const discountServices = new discount_services_1.DiscountServices(discountRepository);
const discountController = new discount_controller_1.DiscountController(discountServices);
