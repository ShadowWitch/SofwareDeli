...
class DiscountController {
    ...
    createOne(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const discountCreated = yield this.discountService.createOne(discountData);
                const httpResponse = {
    ...
    updateOneById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const discountData = req.body;
            try {
                const discountUpdated = yield this.discountService.updateById(id, discountData);
                const httpResponse = {
    ...
    deleteOneById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            try {
                const discountDeleted = yield this.discountService.deleteById(id);
                const httpResponse = {
