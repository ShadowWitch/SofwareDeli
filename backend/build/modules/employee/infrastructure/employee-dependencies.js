...
const employeeRepository = new prisma_employee_repository_1.PrismaEmployeeRepository(prisma_1.prisma);
const employeeServices = new employee_services_1.EmployeeServices(employeeRepository);
const employeeController = new employee_controller_1.EmployeeController(employeeServices);
