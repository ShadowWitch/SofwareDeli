...
class EmployeeController {
    ...
    createOne(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const employeeCreated = yield this.employeeService.createOne(employeeData);
                const httpResponse = {
    ...
    updateOneById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const employeeData = req.body;
            try {
                const employeeUpdated = yield this.employeeService.updateById(id, employeeData);
                const httpResponse = {
    ...
    deleteOneById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            try {
                const employeeDeleted = yield this.employeeService.deleteById(id);
                const httpResponse = {
