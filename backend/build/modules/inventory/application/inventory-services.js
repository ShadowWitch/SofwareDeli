...
class InventoryServices {
    ...
    getInventoryItemsById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const itemsFound = yield this.inventoryRepository.findInventoryItemsById(id);
            return itemsFound;
        });
    }
    createOne(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const itemAlreadyExists = yield this.inventoryRepository.findByName(data.name);
    ...
    updateById(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const itemUpdated = yield this.inventoryRepository.updateById(id, data);
            if (!itemUpdated) {
