...
class InventoryController {
    ...
    getInventoryItemsById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            try {
                const itemsFound = yield this.inventoryService.getInventoryItemsById(id);
    ...
    createOne(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const itemCreated = yield this.inventoryService.createOne(itemData);
                const httpResponse = {
                    data: itemCreated,
                    message: "Created",
                };
    ...
    updateOneById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const itemData = req.body;
            try {
                const itemUpdated = yield this.inventoryService.updateById(id, itemData);
                const httpResponse = {
                    data: itemUpdated,
                    message: "Updated",
                };
