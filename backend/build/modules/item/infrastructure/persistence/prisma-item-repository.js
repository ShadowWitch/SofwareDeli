...
class PrismaItemRepository {
    ...
    findByName(name) {
        return __awaiter(this, void 0, void 0, function* () {
            const item = yield this.prisma.item.findFirst({
                where: { name },
            });
            return item;
        });
    ...
    createOne(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const item = yield this.prisma.item.create({
                data,
            });
            return item;
        });
    ...
    createMany(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const itemsCreated = (yield this.prisma.item.createMany({
                data,
                skipDuplicates: true,
            }));
            return itemsCreated;
    ...
    updateById(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const item = yield this.prisma.item.update({
                where: { id },
                data,
            });
            return item;
    ...
    updateMany(ids, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const itemsUpdated = (yield this.prisma.item.updateMany({
                where: {
                    id: {
                        in: ids,
                    },
    ...
    deleteById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const item = yield this.prisma.item.delete({
                where: { id },
            });
            return item;
        });
