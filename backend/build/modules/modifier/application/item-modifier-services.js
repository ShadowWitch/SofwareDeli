...
class ItemModifierServices {
    ...
    createOne(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const itemAlreadyExists = yield this.itemModifierRepository.findByName(data.name);
            if (itemAlreadyExists) {
                throw new exceptions_1.HttpException(409, "Already exists");
            }
            const itemCreated = yield this.itemModifierRepository.createOne(data);
            if (!itemCreated)
    ...
    updateById(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const itemUpdated = yield this.itemModifierRepository.updateById(id, data);
            if (!itemUpdated) {
    ...
    updateOptions(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const itemUpdated = yield this.itemModifierRepository.updateOptions(id, options);
            if (!itemUpdated) {
                throw new Error("No item updated");
            }
            return itemUpdated;
    ...
    deleteById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const itemDeleted = yield this.itemModifierRepository.deleteById(id);
            if (!itemDeleted) {
    ...
    deleteMany(ids) {
        return __awaiter(this, void 0, void 0, function* () {
            const itemsDeleted = yield this.itemModifierRepository.deleteMany(ids);
            if (!itemsDeleted) {
