...
class ItemModifierController {
    ...
    getSeveral(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const itemModifiersList = yield this.itemModifierService.findServeral({
                    pagination: {
                        limit: parsedLimit,
                        offset: parsedOffset,
                    },
    ...
    getOne(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            try {
                const itemModifierFound = yield this.itemModifierService.findById(id);
    ...
    createOne(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const itemCreated = yield this.itemModifierService.createOne(itemData);
                const httpResponse = {
                    data: itemCreated,
                    message: "Created",
                };
    ...
    updateOneById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const itemData = req.body;
            try {
                const itemModifierUpdated = yield this.itemModifierService.updateById(id, itemData);
                const httpResponse = {
    ...
    updateOptions(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const itemModifierUpdated = yield this.itemModifierService.updateOptions(id, options);
                const httpResponse = {
                    data: itemModifierUpdated,
                    message: "Updated",
                };
    ...
    deleteOneById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            try {
                const itemModifierDeleted = yield this.itemModifierService.deleteById(id);
                const httpResponse = {
    ...
    deleteSeveral(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const { ids } = req.body;
            const itemModifiersDeleted = yield this.itemModifierService.deleteMany(ids);
            try {
