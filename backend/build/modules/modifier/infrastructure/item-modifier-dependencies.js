...
const itemModifierRepository = new prisma_item_modifier_repository_1.PrismaItemModifierRepository(prisma_1.prisma);
const itemModifierServices = new item_modifier_services_1.ItemModifierServices(itemModifierRepository);
const itemModifierController = new item_modifier_controller_1.ItemModifierController(itemModifierServices);
const itemModifierRouter = new item_modifier_routes_1.ItemModifierRouter(itemModifierController);
