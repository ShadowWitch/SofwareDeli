...
class ProviderController {
    ...
    getOneByName(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const providerFound = yield this.providerService.findByName(name);
                return res.status(200).json(providerFound);
            }
            catch (error) {
                next(error);
    ...
    createOne(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const providerCreated = yield this.providerService.createOne(providerData);
                const httpResponse = {
    ...
    updateOneById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const providerData = req.body;
            try {
                const providerUpdated = yield this.providerService.updateById(id, providerData);
                const httpResponse = {
    ...
    deleteOneById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            try {
                const providerDeleted = yield this.providerService.deleteById(id);
                const httpResponse = {
