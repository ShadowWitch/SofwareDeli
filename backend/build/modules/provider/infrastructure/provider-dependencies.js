...
const providerRepository = new prisma_provider_repository_1.PrismaProviderRepository(prisma_1.prisma);
const providerServices = new provider_services_1.ProviderServices(providerRepository);
const providerController = new provider_controller_1.ProviderController(providerServices);
