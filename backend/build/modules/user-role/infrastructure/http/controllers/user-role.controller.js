...
class UserRoleController {
    ...
    createOne(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const userRoleCreated = yield this.userRoleService.createOne(userRoleData);
                const httpResponse = {
    ...
    updateOneById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const userRoleData = req.body;
            try {
                const userRoleUpdated = yield this.userRoleService.updateById(id, userRoleData);
                const httpResponse = {
    ...
    deleteOneById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            try {
                const userRoleDeleted = yield this.userRoleService.deleteById(id);
                const httpResponse = {
