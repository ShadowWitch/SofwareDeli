...
const userRoleRepository = new prisma_user_role_repository_1.PrismaUserRoleRepository(prisma_1.prisma);
const userRoleServices = new user_role_services_1.UserRoleServices(userRoleRepository);
const userRoleController = new user_role_controller_1.UserRoleController(userRoleServices);
const userRoleRouter = new user_role_routes_1.UserRoleRouter(userRoleController);
