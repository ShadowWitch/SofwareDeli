    ...
    execute(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (itemCreated.email) {
                this.emailSender.sendEmail(itemCreated.email, "Bienvenido a la plataforma", `Bienvenido a la plataforma`);
                this.emailSender.sendEmail(itemCreated.email, "Confirma tu cuenta de usuario", `Por favor, confirma tu cuenta de usuario haciendo click en el siguiente enlace: ${config_1.projectConfig.client.publicURL}/confirm-account`);
            }
            return itemCreated;
        });
    }
