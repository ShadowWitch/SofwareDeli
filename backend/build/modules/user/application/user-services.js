...
class UserServices {
    ...
    findByUsername(username) {
        return __awaiter(this, void 0, void 0, function* () {
            const itemFound = yield this.userRepository.findByUsername(username);
            if (!itemFound) {
                throw new exceptions_1.NotFoundException();
            }
            return itemFound;
    ...
    createOne(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (itemCreated.email) {
                this.emailSender.sendEmail(itemCreated.email, "Bienvenido a la plataforma", `Bienvenido a la plataforma. Gracias por registrarte. Si no has solicitado la creación de una cuenta de usuario, ignora este mensaje.`, `
				...
				`);
                this.emailSender.sendEmail(itemCreated.email, "Confirma tu cuenta de usuario", `Por favor, confirma tu cuenta de usuario haciendo click en el siguiente enlace: ${env_1.env.CLIENT_PUBLIC_URL}/account-confirmation`, `
