...
const userRepository = (() => {
    switch (config_1.projectConfig.database.type) {
        case "postgres":
            return new prisma_user_repository_1.PrismaUserRepository(prisma_1.prisma);
        case "mysql":
            return new prisma_user_repository_1.PrismaUserRepository(prisma_1.prisma);
        default:
...
const userServices = new user_services_1.UserServices(userRepository, dependecies_1.emailSender);
