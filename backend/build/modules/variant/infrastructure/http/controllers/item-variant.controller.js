...
class ItemVariantController {
    ...
    getSeveral(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const itemVariantsList = yield this.itemVariantService.findServeral({
                    pagination: {
                        limit: parsedLimit,
                        offset: parsedOffset,
                    },
    ...
    getOne(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            try {
                const itemVariantFound = yield this.itemVariantService.findById(id);
    ...
    createOne(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const itemCreated = yield this.itemVariantService.createOne(itemData);
                const httpResponse = {
                    data: itemCreated,
                    message: "Created",
                };
    ...
    updateOneById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const itemData = req.body;
            try {
                const itemVariantUpdated = yield this.itemVariantService.updateById(id, itemData);
                const httpResponse = {
    ...
    deleteOneById(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            try {
                const itemVariantDeleted = yield this.itemVariantService.deleteById(id);
                const httpResponse = {
    ...
    deleteSeveral(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const { ids } = req.body;
            const itemVariantsDeleted = yield this.itemVariantService.deleteMany(ids);
            try {
