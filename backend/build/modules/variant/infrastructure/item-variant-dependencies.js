...
const itemVariantRepository = new prisma_item_variant_repository_1.PrismaItemVariantRepository(prisma_1.prisma);
const itemVariantServices = new item_variant_services_1.ItemVariantServices(itemVariantRepository);
const itemVariantController = new item_variant_controller_1.ItemVariantController(itemVariantServices);
const itemVariantRouter = new item_variant_routes_1.ItemVariantRouter(itemVariantController);
