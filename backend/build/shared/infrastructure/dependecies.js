...
if (config_1.projectConfig.server.enviroment === NODE_ENV.PRODUCTION) {
    exports.emailSender = emailSender = new gmail_email_sender_1.GmailEmailSender(logger);
}
else {
    exports.emailSender = emailSender = new mailtrap_email_sender_1.MailtrapEmailSender(logger);
}
