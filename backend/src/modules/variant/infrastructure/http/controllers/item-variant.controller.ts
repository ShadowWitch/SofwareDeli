...
export class ItemVariantController {
	...
	public async createOne(req: Request, res: Response, next: NextFunction) {
		...
		try {
			const itemCreated = await this.itemVariantService.createOne(itemData);
	...
	public async updateOneById(
		...
		try {
			const itemVariantUpdated = await this.itemVariantService.updateById(id, itemData);
	...
	public async deleteOneById(
		...
		try {
			const itemVariantDeleted = await this.itemVariantService.deleteById(id);
	...
	public async deleteSeveral(
		...
		const { ids } = req.body;
		const itemVariantsDeleted = await this.itemVariantService.deleteMany(ids);
