...
import { partialItemVariantSchema, itemVariantSchema } from "../../../domain/item-variant.schema";
...
export class ItemVariantRouter implements Route {
	...
	private initializeRoutes() {
		this.router.get(
			this.path,
			isAuthenticated,
			this.itemVariantController.getSeveral.bind(this.itemVariantController)
		);
		...
		this.router.post(
			...
			this.itemVariantController.createOne.bind(this.itemVariantController)
		);
		...
		this.router.delete(
			...
			isAuthenticated,
			validateRequestParams(itemVariantSchema.pick({ id: true })),
			this.itemVariantController.deleteOneById.bind(this.itemVariantController)
		);

		this.router.delete(
			this.path,
			isAuthenticated,
			this.itemVariantController.deleteSeveral.bind(this.itemVariantController)
		);
	}
}
